        ...
        <_items dataType="Array" type="Duality.Component[]" id="1904583532" length="4">
          ...
          <item dataType="Struct" type="Duality.Components.Camera" id="875913021">
            ...
            <passes dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Components.Camera+Pass]]" id="4001437425">
              ...
              <_size dataType="Int">2</_size>
              <_version dataType="Int">61148</_version>
            </passes>
        ...
        <changes dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Resources.PrefabLink+VarMod]]" id="2168175972">
          <_items dataType="Array" type="Duality.Resources.PrefabLink+VarMod[]" id="1688394692" length="4">
            <item dataType="Struct" type="Duality.Resources.PrefabLink+VarMod">
              ...
              <prop dataType="PropertyInfo" id="4201743582" value="P:Duality.Components.Transform:RelativePos" />
              <val dataType="Struct" type="OpenTK.Vector3">
                <X dataType="Float">4.16757965</X>
                <Y dataType="Float">45.5917778</Y>
                <Z dataType="Float">-1</Z>
              </val>
            </item>
            <item dataType="Struct" type="Duality.Resources.PrefabLink+VarMod">
              <childIndex dataType="Struct" type="System.Collections.Generic.List`1[[System.Int32]]" id="362592692">
                <_items dataType="Array" type="System.Int32[]" id="2924534856" />
                <_size dataType="Int">0</_size>
                <_version dataType="Int">1</_version>
              </childIndex>
              <componentType dataType="ObjectRef">1499577572</componentType>
              <prop dataType="PropertyInfo" id="786633250" value="P:Duality.Components.Physics.RigidBody:Shapes" />
              <val dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Components.Physics.ShapeInfo]]" id="2434272000">
                <_items dataType="Array" type="Duality.Components.Physics.ShapeInfo[]" id="3349698164" length="4">
                  <item dataType="Struct" type="Duality.Components.Physics.PolyShapeInfo" id="1287196580">
                    <density dataType="Float">1</density>
                    <friction dataType="Float">0.3</friction>
                    <parent />
                    <restitution dataType="Float">0.3</restitution>
                    <sensor dataType="Bool">false</sensor>
                    <vertices dataType="Array" type="OpenTK.Vector2[]" id="1840628932">
                      <item dataType="Struct" type="OpenTK.Vector2">
          ...
          <_size dataType="Int">2</_size>
          <_version dataType="Int">170</_version>
        </changes>
