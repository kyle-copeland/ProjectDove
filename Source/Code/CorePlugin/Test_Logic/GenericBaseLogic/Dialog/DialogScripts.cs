...
namespace Dove_Game.Test_Logic
{
    public static class DialogScripts
    {
        ...
        {
            new DialogComponent(false, "Unknown: Whe….where am I?", ContentRefs.BigHeadGoku, null, -1),
            new DialogComponent(false, "MetaKnight: You're in Whispy Woods, the only place that isn’t completely gone.", ContentRefs.BigHeadGoku, null, -1),
            new DialogComponent(false, "Unknown: Wait... who are you and what do you mean gone...?", ContentRefs.BigHeadGoku, null, -1),
            new DialogComponent(false, "MetaKnight: My name is Meta Knight, and for the longest time, the Nintendo Universe was at peace. But it wasn't long until something unexplainable entered our world.", ContentRefs.BigHeadGoku, null, -1),
            new DialogComponent(false, "Unknown: Wha...at do you mean unexplainable…? and who am I? What happened…?", ContentRefs.BigHeadGoku, null, -1),
            new DialogComponent(false, "MetaKnight: Players have been disappearing, good guys are now bad guys, and our world seems to be getting darker by the minute. You mean you don’t remember anything?", ContentRefs.BigHeadGoku, null, -1),
            new DialogComponent(false, "Unknown: I...I don’t know…. who I am…. what happened to me nor what’s going on…?", ContentRefs.BigHeadGoku, null, -1),
            ...
            new DialogComponent(false, "I... I don't even know who I am or what happened to me...", ContentRefs.BigHeadGoku, null, -1),
            new DialogComponent(false, "Unknown: Who...’s King Kai?", ContentRefs.BigHeadGoku, null, -1),
            new DialogComponent(false, "MetaKnight: He’s a strange guy with a monkey. He tends to help people with any type of problems. You can find him by that Snake Way on top of us.", ContentRefs.BigHeadGoku, null, -1),
            new DialogComponent(false, "Unknown: How do I get there?", ContentRefs.BigHeadGoku, null, -1),
            
            new DialogComponent(false, "MetaKnight: Grab on!", ContentRefs.GokuHero, ContentRefs.WorldMapScene, -1)
        };

        public static List<DialogComponent> DbzLevelOnePre = new List<DialogComponent>
        {
            new DialogComponent(false, "MetaKnight: Here’s the deal kid, SnakeWay is basically our heaven. It's home to all characters who died, both good and bad. The only way to gain access to Kai’s planet is through invitation or summon.", ContentRefs.BigHeadGoku, null, -1),
            new DialogComponent(false, "Unknown: Summon...?", ContentRefs.BigHeadGoku, null, -1),
            new DialogComponent(false, "MetaKnight: By summon I mean Shenron, the dragon who can only be summoned with all seven dragonballs. If you summon him, he can send you to King Kai.", ContentRefs.BigHeadGoku, null, -1),
            new DialogComponent(false, "Unknown: So how do I get these “Dragon Balls”?", ContentRefs.BigHeadGoku, null, -1),
            new DialogComponent(false, "MetaKnight: Lucky for you, all seven have already been gathered by Cell and Frieza’s henchmen to summon Shenron later tonight. All you have to do is defeat them and take the dragon balls. That’s why I’ve brought you to Snake Way.", ContentRefs.BigHeadGoku, null, -1),
            new DialogComponent(false, "Unknown: I… need to talk to King Kai…", ContentRefs.BigHeadGoku, null, -1),
            
            new DialogComponent(false, "MetaKnight: Well then, you need to get those dragon balls! Good luck kid!", ContentRefs.GokuHero, ContentRefs.DbzSnakeWay, -1)
        };

        public static List<DialogComponent> DbzLevelOnePost = new List<DialogComponent>
        {
            new DialogComponent(false, "Unknown: These must be the dragon balls Meta Knight was referring to…", ContentRefs.BigHeadGoku, null, -1),
            new DialogComponent(false, "Unknown: Wait! What’s happening!?", ContentRefs.BigHeadGoku, null, -1),
            new DialogComponent(false, "--- Shenron appears ---", ContentRefs.BigHeadGoku, null, -1),
            new DialogComponent(false, "Shenron: I am Shenron, who summons me?", ContentRefs.BigHeadGoku, null, -1),
            new DialogComponent(false, "Unknown: Uh… I think I did…", ContentRefs.BigHeadGoku, null, -1),
            new DialogComponent(false, "Shenron: Well then, what is your wish?", ContentRefs.BigHeadGoku, null, -1),
            new DialogComponent(false, "Unknown: I need to see King Kai! Can you take me to him?", ContentRefs.BigHeadGoku, null, -1),
            
            new DialogComponent(false, "Shenron: As you wish.", ContentRefs.GokuHero, ContentRefs.DbzLevelTwoPre, 0)
        };
        ...
        public static List<DialogComponent> DbzLevelTwoPost = new List<DialogComponent>
        {
            ...
            new DialogComponent(false, "Goku: Come on King Kai, don’t freak the kid out haha. What is your name kid?", ContentRefs.DbzKKP_GKK, null, -1),
            ...
            new DialogComponent(false, "Goku: All this talk about an ultimate evil gets me excited! Too bad I can’t face him like King Kai says. But if you’re as special as King Kai says, I want to see that for myself! Let’s see if you have what it takes kid.", ContentRefs.DbzKKP_UG, ContentRefs.DbzBossFight, -1)
        };
        ...
        public static List<DialogComponent> DbzGokuFightPost = new List<DialogComponent>
        {
            ...
            new DialogComponent(false, "Bowser's Minion: HELPPPPP!!! My master bowser has been locked up by Mario and Mario is going to destroy everythinggggg.", ContentRefs.DbzKKP_GKK, null, -1),
            ...
            new DialogComponent(false, "Bowser's Minion: YIPPEE", ContentRefs.DbzKKP_GKK, ContentRefs.MarioLevelOnePre, 1)
        };

        public static List<DialogComponent> MarioLevelOnePre = new List<DialogComponent>
        {
            new DialogComponent(false, "Peach: Thanks goodness you heroes are here! Everything has been going into chaos and all of our heroes are being held captive by the evil Mario!", ContentRefs.BigHeadGoku, null, -1),
            new DialogComponent(false, "Goku: That’s not good… When did this all start?", ContentRefs.BigHeadGoku, null, -1),
            new DialogComponent(false, "Peach: Well, I was watering my piranha one day when an explosion occurred in the town center. When I rushed over, all I saw was Mario on the ground and he looked darker than usual.", ContentRefs.BigHeadGoku, null, -1),
            new DialogComponent(false, "Unknown: Darker? What do you mean darker?", ContentRefs.BigHeadGoku, null, -1),
            new DialogComponent(false, "Peach: Well he had an evil glow to him and he didn’t sound like himself. The only words he says now are “Evil” and “Slender”.", ContentRefs.BigHeadGoku, null, -1),
            new DialogComponent(false, "Unknown: Slender as in referring to Slenderman?", ContentRefs.BigHeadGoku, null, -1),
            new DialogComponent(false, "Goku: Theres our next clue… Where is Mario now? ", ContentRefs.BigHeadGoku, null, -1),
            new DialogComponent(false, "Peach: He invaded Bowser’s castle earlier, now that castle is the holding grounds for all prisoners and Mario is the king.", ContentRefs.BigHeadGoku, null, -1),
            new DialogComponent(false, "Goku: We better hurry before Mario turns all the heroes evil.", ContentRefs.BigHeadGoku, null, -1),
            
            new DialogComponent(false, "Peach: Good luck my heroes!", ContentRefs.GokuHero, ContentRefs.MarioWorld, -1)
        };
        ...
        public static List<DialogComponent> MarioLevelOnePostTwoPre = new List<DialogComponent>
        {
            ...
            new DialogComponent(false, "Goku: Only time will tell… Let’s go.", ContentRefs.CastleUG, ContentRefs.MarioCastle, -1)
        };
        ...
        public static List<DialogComponent> MarioLevelTwoPostBossPre = new List<DialogComponent>
        {
            ...
            new DialogComponent(false, "Mario: Is that so? We’ll see about that!", ContentRefs.CastleUM, ContentRefs.MarioBossFight, -1)
        };
        ...
        public static List<DialogComponent> MarioLevelBossPost = new List<DialogComponent>
        {
            ...
            new DialogComponent(false, "Unknown: Let’s roll!", ContentRefs.CastleUG, ContentRefs.LinkLevelOnePre, 2)
        };

        public static List<DialogComponent> LinkLevelOnePre = new List<DialogComponent>
        {
            new DialogComponent(false, "Unknown: I don’t see Link anywhere… It sure is dark here though.", ContentRefs.BigHeadGoku, null, -1),
            new DialogComponent(false, "Goku: Yeah I’m getting an eery feeling here. It’s different from how Mario’s land was…", ContentRefs.BigHeadGoku, null, -1),
            
            new DialogComponent(false, "Unknown: Let’s go deeper into the forest, maybe Link is at the end.", ContentRefs.GokuHero, ContentRefs.LinkForest, -1)
        };
