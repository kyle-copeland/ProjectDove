...
namespace Dove_Game.Test_Logic
{
    public static class DialogScripts
    {
        ...
        {
            new DialogComponent(false, @"Unknown: Where... where am I?", ContentRefs.First_UMK, null, -1),
        ...
        public static List<DialogComponent> DbzLevelTwoPost = new List<DialogComponent>
        {
            ...
            new DialogComponent(false, "Goku: What is your name kid?", ContentRefs.DbzKKP_UG, null, -1),
        ...
        public static List<DialogComponent> MarioLevelBossPost = new List<DialogComponent>
        {
            ...
            new DialogComponent(false, "Bowser: Heroes, I'm afraid to say that things are far from over.", ContentRefs.CastleUB, null, -1),
            new DialogComponent(false, "Goku: What do you mean?", ContentRefs.CastleGB, null, -1),
            new DialogComponent(false, "Bowser: I've just heard that Hyrule is currently suffering from the fate. Their hero, Link, has suddenly had a change of heart and their world will soon plummet into eternal chaos...", ContentRefs.CastleGB, null, -1),
        ...
        public static List<DialogComponent> LinkLevelBossPost = new List<DialogComponent>
        {
            ...
            new DialogComponent(false, "Navi: Thank you! I'm free now! But I have bad news... The darkness seems to be getting stronger and stronger. I don't think we can stop it now.. It might be too late for us...", ContentRefs.LinkCastleUG, null, -1),
            new DialogComponent(false, "Unknown: What do you mean? There has to be a way...", ContentRefs.LinkCastleUN, null, -1),
            new DialogComponent(false, "Navi: Maybe if we stop the darkness from it's roots...", ContentRefs.LinkCastleUN, null, -1),
        ...
        public static List<DialogComponent> FinalBossPre = new List<DialogComponent>
        {
            ...
            new DialogComponent(false, "Unknown: Me. I won't let our universe fall to your tyranny. I'm here to destroy you!", ContentRefs.SlenderUS, GameRes.Data.Scenes.FinalWorlds.FinalBoss_Scene, -1)
        };
    }
}
