        ...
        <_items dataType="Array" type="Duality.Component[]" id="66565582" length="4">
          ...
          <item dataType="Struct" type="Duality.Components.Camera" id="1297895924">
            ...
            <passes dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Components.Camera+Pass]]" id="4095652320">
              ...
              <_version dataType="Int">3338</_version>
            </passes>
      ...
      <compMap dataType="Struct" type="System.Collections.Generic.Dictionary`2[[System.Type],[Duality.Component]]" id="2776016384" surrogate="true">
        ...
        <body>
          <keys dataType="Array" type="System.Type[]" id="3571931661">
            <item dataType="Type" id="2425389862" value="Duality.Components.Transform" />
            <item dataType="Type" id="3524272826" value="Duality.Components.Camera" />
            <item dataType="Type" id="3861372966" value="Dove_Game.Test_Logic.CameraController" />
          </keys>
      ...
      <compMap dataType="Struct" type="System.Collections.Generic.Dictionary`2[[System.Type],[Duality.Component]]" id="470876054" surrogate="true">
        ...
        <body>
          <keys dataType="Array" type="System.Type[]" id="924868950">
            <item dataType="ObjectRef">2425389862</item>
      ...
      <compList dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Component]]" id="2028127307">
        <_items dataType="Array" type="Duality.Component[]" id="972568310" length="4">
          <item dataType="Struct" type="Dove_Game.Test_Logic.GameController" id="923383473">
            <_drawHealth dataType="Struct" type="Dove_Game.Test_Logic.DrawHealth" id="4166357084">
              <active dataType="Bool">true</active>
              <font dataType="Struct" type="Duality.ContentRef`1[[Duality.Resources.Font]]">
                <contentPath />
              </font>
              <gameobj dataType="Struct" type="Duality.GameObject" id="1013697174">
                <active dataType="Bool">true</active>
                <children />
                <compList dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Component]]" id="960938123">
                  <_items dataType="Array" type="Duality.Component[]" id="1854535286" length="4">
                    <item dataType="ObjectRef">4166357084</item>
                  </_items>
                  <_size dataType="Int">1</_size>
                  <_version dataType="Int">1</_version>
                </compList>
                <compMap dataType="Struct" type="System.Collections.Generic.Dictionary`2[[System.Type],[Duality.Component]]" id="928840904" surrogate="true">
                  <header />
                  <body>
                    <keys dataType="Array" type="System.Type[]" id="2738665505">
                      <item dataType="Type" id="2947693166" value="Dove_Game.Test_Logic.DrawHealth" />
                    </keys>
                    <values dataType="Array" type="Duality.Component[]" id="516814112">
                      <item dataType="ObjectRef">4166357084</item>
                    </values>
                  </body>
                </compMap>
                ...
                <identifier dataType="Struct" type="System.Guid" surrogate="true">
                  <header>
                    <data dataType="Array" type="System.Byte[]" id="2669772211">x4+W6f2njUWPXnKZLSBd3A==</data>
                  </header>
                  <body />
                </identifier>
                <initState dataType="Enum" type="Duality.InitState" name="Initialized" value="1" />
      ...
      <compList dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Component]]" id="4106330320">
        <_items dataType="Array" type="Duality.Component[]" id="2750966460" length="4">
          <item dataType="Struct" type="Dove_Game.Test_Logic.DrawHealth" id="3387744716">
            ...
            <initState dataType="Enum" type="Duality.InitState" name="Initialized" value="1" />
            <playerOne dataType="Struct" type="Dove_Game.PlayerOne" id="708683721">
              <active dataType="Bool">true</active>
              <gameobj dataType="Struct" type="Duality.GameObject" id="3606380453">
                <active dataType="Bool">true</active>
                <children />
                <compList dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Component]]" id="1919490382">
                  <_items dataType="Array" type="Duality.Component[]" id="3238200016">
                    <item dataType="Struct" type="Duality.Components.Transform" id="1671728089">
                      <active dataType="Bool">true</active>
                ...
                <compMap dataType="Struct" type="System.Collections.Generic.Dictionary`2[[System.Type],[Duality.Component]]" id="2011864650" surrogate="true">
                  <header />
                  <body>
                    <keys dataType="Array" type="System.Type[]" id="1574058508">
                      <item dataType="ObjectRef">2425389862</item>
                      <item dataType="Type" id="2594591908" value="Duality.Components.Renderers.AnimSpriteRenderer" />
                      <item dataType="Type" id="1066058518" value="Duality.Components.Physics.RigidBody" />
                      <item dataType="Type" id="2925335456" value="Dove_Game.PlayerOne" />
                    </keys>
                    <values dataType="Array" type="Duality.Component[]" id="1587258102">
                ...
                <identifier dataType="Struct" type="System.Guid" surrogate="true">
                  <header>
                    <data dataType="Array" type="System.Byte[]" id="1235122840">FLMwj8Qm0EyMuH9B/Db6YQ==</data>
                  </header>
                  <body />
                </identifier>
                <initState dataType="Enum" type="Duality.InitState" name="Initialized" value="1" />
                ...
                <parent />
                <prefabLink dataType="Struct" type="Duality.Resources.PrefabLink" id="2260678910">
                  <changes />
      ...
      <compMap dataType="Struct" type="System.Collections.Generic.Dictionary`2[[System.Type],[Duality.Component]]" id="1038738030" surrogate="true">
        ...
        <body>
          <keys dataType="Array" type="System.Type[]" id="4135680930">
            <item dataType="ObjectRef">2947693166</item>
          </keys>
      ...
      <compMap dataType="Struct" type="System.Collections.Generic.Dictionary`2[[System.Type],[Duality.Component]]" id="1058817758" surrogate="true">
        ...
        <body>
          <keys dataType="Array" type="System.Type[]" id="876424586">
            <item dataType="ObjectRef">2425389862</item>
            <item dataType="ObjectRef">1066058518</item>
          </keys>
        ...
        <changes dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Resources.PrefabLink+VarMod]]" id="2448260248">
          <_items dataType="Array" type="Duality.Resources.PrefabLink+VarMod[]" id="1219684908" length="4">
            <item dataType="Struct" type="Duality.Resources.PrefabLink+VarMod">
              ...
              <componentType dataType="ObjectRef">1066058518</componentType>
      ...
      <compList dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Component]]" id="980111681">
        <_items dataType="Array" type="Duality.Component[]" id="3505850798" length="4">
          <item dataType="Struct" type="Dove_Game.Test_Logic.SnakeWayLevelController" id="1559528530">
            <_currentEnemy />
            <_delayProgress dataType="Float">1731.61816</_delayProgress>
            <_enemyList dataType="Struct" type="System.Collections.Generic.List`1[[Duality.ContentRef`1[[Duality.Resources.Prefab]]]]" id="3508549878">
              <_items dataType="Array" type="Duality.ContentRef`1[[Duality.Resources.Prefab]][]" id="3511198944" length="8">
                <item dataType="Struct" type="Duality.ContentRef`1[[Duality.Resources.Prefab]]">
                  <contentPath dataType="String">Data\Prefabs\Dbz_Enemy1.Prefab.res</contentPath>
                </item>
                <item dataType="Struct" type="Duality.ContentRef`1[[Duality.Resources.Prefab]]">
                  <contentPath dataType="String">Data\Prefabs\Dbz_Enemy2.Prefab.res</contentPath>
                </item>
                <item dataType="Struct" type="Duality.ContentRef`1[[Duality.Resources.Prefab]]">
                  <contentPath dataType="String">Data\Prefabs\Dbz_Enemy3.Prefab.res</contentPath>
                </item>
                <item dataType="Struct" type="Duality.ContentRef`1[[Duality.Resources.Prefab]]">
                  <contentPath dataType="String">Data\Prefabs\Dbz_Enemy4.Prefab.res</contentPath>
                </item>
                <item dataType="Struct" type="Duality.ContentRef`1[[Duality.Resources.Prefab]]">
                  <contentPath dataType="String">Data\Prefabs\Dbz_Cell.Prefab.res</contentPath>
                </item>
              </_items>
