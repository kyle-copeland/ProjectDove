<root dataType="Struct" type="Duality.Resources.Scene" id="129723834">
  ...
  <serializeObj dataType="Array" type="Duality.GameObject[]" id="427169525">
    ...
    <item dataType="Struct" type="Duality.GameObject" id="2477722482">
      <active dataType="Bool">true</active>
      <children dataType="Struct" type="System.Collections.Generic.List`1[[Duality.GameObject]]" id="3721770652">
        <_items dataType="Array" type="Duality.GameObject[]" id="1902644164" length="4">
          <item dataType="Struct" type="Duality.GameObject" id="835370325">
            <active dataType="Bool">true</active>
            <children />
            <compList dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Component]]" id="1877986937">
              <_items dataType="Array" type="Duality.Component[]" id="1697497934" length="4">
                <item dataType="Struct" type="Duality.Components.Transform" id="3195685257">
                  ...
                  <ignoreParent dataType="Bool">false</ignoreParent>
                  <initState dataType="Enum" type="Duality.InitState" name="Initialized" value="1" />
                  <parentTransform dataType="Struct" type="Duality.Components.Transform" id="543070118">
                    <active dataType="Bool">true</active>
                    <gameobj dataType="ObjectRef">2477722482</gameobj>
                    <initState dataType="Enum" type="Duality.InitState" name="Initialized" value="1" />
                  </parentTransform>
                  <pos dataType="Struct" type="OpenTK.Vector3">
                    <X dataType="Float">34.9767876</X>
                    <Y dataType="Float">-204.896912</Y>
                    <Z dataType="Float">-395.124176</Z>
                  </pos>
                  <posAbs dataType="Struct" type="OpenTK.Vector3">
                    <X dataType="Float">-43.6850433</X>
                    <Y dataType="Float">-7.72287</Y>
                    <Z dataType="Float">-253.0866</Z>
                  </posAbs>
                  <scale dataType="Float">1.56741452</scale>
                  <scaleAbs dataType="Float">1</scaleAbs>
                  <vel dataType="Struct" type="OpenTK.Vector3">
                    <X dataType="Float">0</X>
                    <Y dataType="Float">0</Y>
                ...
                <item dataType="Struct" type="Duality.Components.Camera" id="1372646132">
                  ...
                  <passes dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Components.Camera+Pass]]" id="1766326752">
                    <_items dataType="Array" type="Duality.Components.Camera+Pass[]" id="4037176284" length="8">
                      <item dataType="Struct" type="Duality.Components.Camera+Pass" id="1537940164">
                      ...
                      <item dataType="Struct" type="Duality.Components.Camera+Pass" id="4139815830">
                        <clearColor dataType="Struct" type="Duality.Drawing.ColorRgba">
                          <A dataType="Byte">0</A>
                          <B dataType="Byte">0</B>
                          <G dataType="Byte">0</G>
                    ...
                    <_size dataType="Int">2</_size>
                    <_version dataType="Int">73292</_version>
                  </passes>
            ...
            <compMap dataType="Struct" type="System.Collections.Generic.Dictionary`2[[System.Type],[Duality.Component]]" id="2477168000" surrogate="true">
              <header />
              <body>
                <keys dataType="Array" type="System.Type[]" id="1191674323">
                  <item dataType="ObjectRef">1717510894</item>
                  <item dataType="Type" id="4280689254" value="Duality.Components.Camera" />
                </keys>
                <values dataType="Array" type="Duality.Component[]" id="3067774584">
            ...
            <identifier dataType="Struct" type="System.Guid" surrogate="true">
              <header>
                <data dataType="Array" type="System.Byte[]" id="2600942521">cfzOwwQTT0GljOFOoR27aw==</data>
              </header>
              <body />
            </identifier>
            <initState dataType="Enum" type="Duality.InitState" name="Initialized" value="1" />
            <name dataType="String">Camera</name>
            <parent dataType="ObjectRef">2477722482</parent>
            <prefabLink />
          </item>
        </_items>
        <_size dataType="Int">1</_size>
      ...
      <compList dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Component]]" id="187974166">
        <_items dataType="Array" type="Duality.Component[]" id="1534561334">
      ...
      <compMap dataType="Struct" type="System.Collections.Generic.Dictionary`2[[System.Type],[Duality.Component]]" id="3325251848" surrogate="true">
        <header />
        <body>
          <keys dataType="Array" type="System.Type[]" id="4077698712">
            <item dataType="ObjectRef">1717510894</item>
            <item dataType="ObjectRef">3778121360</item>
            <item dataType="ObjectRef">1683402974</item>
            <item dataType="Type" id="1108178476" value="Dove_Game.PlayerOne" />
          </keys>
          <values dataType="Array" type="Duality.Component[]" id="3084996894">
            <item dataType="ObjectRef">543070118</item>
      ...
      <identifier dataType="Struct" type="System.Guid" surrogate="true">
        <header>
          <data dataType="Array" type="System.Byte[]" id="1927388356">lEdajfXa7UyAbsRAUa5TCw==</data>
        </header>
        <body />
      </identifier>
      <initState dataType="Enum" type="Duality.InitState" name="Initialized" value="1" />
      ...
      <parent />
      <prefabLink dataType="Struct" type="Duality.Resources.PrefabLink" id="541895602">
        <changes dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Resources.PrefabLink+VarMod]]" id="3932137354">
          <_items dataType="Array" type="Duality.Resources.PrefabLink+VarMod[]" id="597737440" length="4">
            <item dataType="Struct" type="Duality.Resources.PrefabLink+VarMod">
              <childIndex dataType="Struct" type="System.Collections.Generic.List`1[[System.Int32]]" id="843455120">
                <_items dataType="Array" type="System.Int32[]" id="2184740156" />
                <_size dataType="Int">0</_size>
                <_version dataType="Int">1</_version>
              </childIndex>
              <componentType />
              <prop dataType="PropertyInfo" id="2445061870" value="P:Duality.GameObject:Name" />
              <val dataType="String">MainCharacter</val>
            </item>
            <item dataType="Struct" type="Duality.Resources.PrefabLink+VarMod">
              <childIndex dataType="Struct" type="System.Collections.Generic.List`1[[System.Int32]]" id="2947661676">
                <_items dataType="Array" type="System.Int32[]" id="3674582648" />
                <_size dataType="Int">0</_size>
                <_version dataType="Int">1</_version>
              </childIndex>
              <componentType dataType="ObjectRef">1717510894</componentType>
        ...
        <changes dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Resources.PrefabLink+VarMod]]" id="2294309700">
          <_items dataType="Array" type="Duality.Resources.PrefabLink+VarMod[]" id="563693124" length="4">
            <item dataType="Struct" type="Duality.Resources.PrefabLink+VarMod">
              ...
              <componentType />
              <prop dataType="ObjectRef">2445061870</prop>
    ...
    <item dataType="ObjectRef">835370325</item>
  </serializeObj>
  <sourcePath />
</root>
