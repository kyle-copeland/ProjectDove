<root dataType="Struct" type="Duality.Resources.Scene" id="129723834">
  ...
  <serializeObj dataType="Array" type="Duality.GameObject[]" id="427169525">
    ...
    <item dataType="Struct" type="Duality.GameObject" id="2114886430">
      <active dataType="Bool">true</active>
      <children />
      <compList dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Component]]" id="1518753416">
        <_items dataType="Array" type="Duality.Component[]" id="2034579308" length="4">
          <item dataType="Struct" type="Duality.Components.Transform" id="180234066">
            <active dataType="Bool">true</active>
            <angle dataType="Float">0</angle>
            <angleAbs dataType="Float">0</angleAbs>
            <angleVel dataType="Float">0</angleVel>
            <angleVelAbs dataType="Float">0</angleVelAbs>
            <deriveAngle dataType="Bool">true</deriveAngle>
            <gameobj dataType="ObjectRef">2114886430</gameobj>
            <ignoreParent dataType="Bool">false</ignoreParent>
            <initState dataType="Enum" type="Duality.InitState" name="Initialized" value="1" />
            <parentTransform />
            <pos dataType="Struct" type="OpenTK.Vector3">
          ...
          <item dataType="Struct" type="Duality.Components.SoundEmitter" id="4158778317">
            <active dataType="Bool">true</active>
            <gameobj dataType="ObjectRef">2114886430</gameobj>
            <initState dataType="Enum" type="Duality.InitState" name="Initialized" value="1" />
            <sources dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Components.SoundEmitter+Source]]" id="4005180161">
              <_items dataType="Array" type="Duality.Components.SoundEmitter+Source[]" id="500068654" length="4">
                <item dataType="Struct" type="Duality.Components.SoundEmitter+Source" id="2051983184">
      ...
      <compMap dataType="Struct" type="System.Collections.Generic.Dictionary`2[[System.Type],[Duality.Component]]" id="4140454878" surrogate="true">
        <header />
        <body>
          <keys dataType="Array" type="System.Type[]" id="2342950730">
            <item dataType="ObjectRef">2839245824</item>
            <item dataType="Type" id="499298144" value="Duality.Components.SoundEmitter" />
          </keys>
          <values dataType="Array" type="Duality.Component[]" id="2119090842">
            <item dataType="ObjectRef">180234066</item>
            <item dataType="ObjectRef">4158778317</item>
          </values>
        </body>
      </compMap>
      <compTransform dataType="ObjectRef">180234066</compTransform>
      <identifier dataType="Struct" type="System.Guid" surrogate="true">
        <header>
          <data dataType="Array" type="System.Byte[]" id="786964650">DNiGeYjQQ0ODitfcDVVXUQ==</data>
        </header>
        <body />
      </identifier>
      <initState dataType="Enum" type="Duality.InitState" name="Initialized" value="1" />
