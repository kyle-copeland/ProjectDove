      ...
      <compList dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Component]]" id="2938727518">
        <_items dataType="Array" type="Duality.Component[]" id="558361872" length="4">
          <item dataType="Struct" type="Dove_Game.Test_Logic.DrawDialog" id="3502353452">
            ...
            <_currentDialog dataType="Struct" type="Dove_Game.Test_Logic.DialogComponent" id="701899348">
              <_x003C_DialogMessage_x003E_k__BackingField dataType="String">You're in Whispy Woods, the only place that isn’t completely gone.</_x003C_DialogMessage_x003E_k__BackingField>
              ...
              <_x003C_nextScriptDialog_x003E_k__BackingField />
