<root dataType="Struct" type="Duality.Resources.Scene" id="129723834">
  ...
  <serializeObj dataType="Array" type="Duality.GameObject[]" id="427169525">
    ...
    <item dataType="Struct" type="Duality.GameObject" id="1131900066">
      <active dataType="Bool">true</active>
      <children />
      <compList dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Component]]" id="2533735020">
        <_items dataType="Array" type="Duality.Component[]" id="2987496292" length="4">
          <item dataType="Struct" type="Duality.Components.Transform" id="3492214998">
            <active dataType="Bool">true</active>
            <angle dataType="Float">0</angle>
            <angleAbs dataType="Float">0</angleAbs>
            <angleVel dataType="Float">0</angleVel>
            <angleVelAbs dataType="Float">0</angleVelAbs>
            <deriveAngle dataType="Bool">true</deriveAngle>
            <gameobj dataType="ObjectRef">1131900066</gameobj>
            <ignoreParent dataType="Bool">false</ignoreParent>
            <initState dataType="Enum" type="Duality.InitState" name="Initialized" value="1" />
            <parentTransform />
            <pos dataType="Struct" type="OpenTK.Vector3">
          ...
          <item dataType="Struct" type="Duality.Components.SoundEmitter" id="3175791953">
            <active dataType="Bool">true</active>
            <gameobj dataType="ObjectRef">1131900066</gameobj>
            <initState dataType="Enum" type="Duality.InitState" name="Initialized" value="1" />
            <sources dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Components.SoundEmitter+Source]]" id="1513149165">
              <_items dataType="Array" type="Duality.Components.SoundEmitter+Source[]" id="1419796198" length="4">
                <item dataType="Struct" type="Duality.Components.SoundEmitter+Source" id="3803477376">
      ...
      <compMap dataType="Struct" type="System.Collections.Generic.Dictionary`2[[System.Type],[Duality.Component]]" id="117547062" surrogate="true">
        <header />
        <body>
          <keys dataType="Array" type="System.Type[]" id="1628595878">
            <item dataType="ObjectRef">2839245824</item>
            <item dataType="Type" id="3865820672" value="Duality.Components.SoundEmitter" />
          </keys>
          <values dataType="Array" type="Duality.Component[]" id="3993987002">
            <item dataType="ObjectRef">3492214998</item>
            <item dataType="ObjectRef">3175791953</item>
          </values>
        </body>
      </compMap>
      <compTransform dataType="ObjectRef">3492214998</compTransform>
      <identifier dataType="Struct" type="System.Guid" surrogate="true">
        <header>
          <data dataType="Array" type="System.Byte[]" id="2180950182">FiIl41K2VU60/xbuv/iI4Q==</data>
        </header>
        <body />
      </identifier>
      <initState dataType="Enum" type="Duality.InitState" name="Initialized" value="1" />
