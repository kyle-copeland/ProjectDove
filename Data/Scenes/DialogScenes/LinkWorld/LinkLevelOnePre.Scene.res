<root dataType="Struct" type="Duality.Resources.Scene" id="129723834">
  ...
  <serializeObj dataType="Array" type="Duality.GameObject[]" id="427169525">
    ...
    <item dataType="Struct" type="Duality.GameObject" id="6865987">
      <active dataType="Bool">true</active>
      <children />
      <compList dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Component]]" id="2348417393">
        <_items dataType="Array" type="Duality.Component[]" id="758037678" length="4">
          <item dataType="Struct" type="Duality.Components.Transform" id="2367180919">
            <active dataType="Bool">true</active>
            <angle dataType="Float">0</angle>
            <angleAbs dataType="Float">0</angleAbs>
            <angleVel dataType="Float">0</angleVel>
            <angleVelAbs dataType="Float">0</angleVelAbs>
            <deriveAngle dataType="Bool">true</deriveAngle>
            <gameobj dataType="ObjectRef">6865987</gameobj>
            <ignoreParent dataType="Bool">false</ignoreParent>
            <initState dataType="Enum" type="Duality.InitState" name="Initialized" value="1" />
            <parentTransform />
            <pos dataType="Struct" type="OpenTK.Vector3">
          ...
          <item dataType="Struct" type="Duality.Components.SoundEmitter" id="2050757874">
            <active dataType="Bool">true</active>
            <gameobj dataType="ObjectRef">6865987</gameobj>
            <initState dataType="Enum" type="Duality.InitState" name="Initialized" value="1" />
            <sources dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Components.SoundEmitter+Source]]" id="2875997910">
              <_items dataType="Array" type="Duality.Components.SoundEmitter+Source[]" id="441945376" length="4">
                <item dataType="Struct" type="Duality.Components.SoundEmitter+Source" id="2498791388">
      ...
      <compMap dataType="Struct" type="System.Collections.Generic.Dictionary`2[[System.Type],[Duality.Component]]" id="3267959008" surrogate="true">
        <header />
        <body>
          <keys dataType="Array" type="System.Type[]" id="1507530459">
            <item dataType="ObjectRef">2839245824</item>
            <item dataType="Type" id="2354007702" value="Duality.Components.SoundEmitter" />
          </keys>
          <values dataType="Array" type="Duality.Component[]" id="4059496808">
            <item dataType="ObjectRef">2367180919</item>
            <item dataType="ObjectRef">2050757874</item>
          </values>
        </body>
      </compMap>
      <compTransform dataType="ObjectRef">2367180919</compTransform>
      <identifier dataType="Struct" type="System.Guid" surrogate="true">
        <header>
          <data dataType="Array" type="System.Byte[]" id="3697319953">z4f1T52lOkOE9+qZoTqbtg==</data>
        </header>
        <body />
      </identifier>
      <initState dataType="Enum" type="Duality.InitState" name="Initialized" value="1" />
